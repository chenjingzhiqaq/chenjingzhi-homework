...
public class GoodsInfo2 {
    ...
    public GoodsInfo2(int pic_id, String title, String desc) {
        this.pic_id = pic_id;
        this.title = title;
        this.desc = desc;
        this.bPressed = false;
    ...
    public static ArrayList<GoodsInfo2> getDefaultList() {
        ArrayList<GoodsInfo2> listArray = new ArrayList<GoodsInfo2>();
        for (int i = 0; i < listImageArray.length; i++) {
            listArray.add(new GoodsInfo2(listImageArray[i], listTitleArray[i], listDescArray[i]));
        }
        return listArray;
    }
    ...
    public static ArrayList<GoodsInfo2> getDefaultGrid() {
        ArrayList<GoodsInfo2> gridArray = new ArrayList<GoodsInfo2>();
        for (int i = 0; i < gridImageArray.length; i++) {
            gridArray.add(new GoodsInfo2(gridImageArray[i], gridTitleArray[i], null));
        }
        return gridArray;
    }
    ...
    public static ArrayList<GoodsInfo2> getDefaultStag() {
        ArrayList<GoodsInfo2> stagArray = new ArrayList<GoodsInfo2>();
        for (int i = 0; i < stagImageArray.length; i++) {
            stagArray.add(new GoodsInfo2(stagImageArray[i], stagTitleArray[i], null));
        }
        return stagArray;
    }
    ...
    public static ArrayList<GoodsInfo2> getDefaultCombine() {
        ArrayList<GoodsInfo2> combineArray = new ArrayList<GoodsInfo2>();
        for (int i = 0; i < combineImageArray.length; i++) {
            combineArray.add(new GoodsInfo2(combineImageArray[i], combineTitleArray[i], null));
        }
        return combineArray;
    }
    ...
    public static ArrayList<GoodsInfo2> getDefaultAppi() {
        ArrayList<GoodsInfo2> appiArray = new ArrayList<GoodsInfo2>();
        for (int i = 0; i < appiImageArray.length; i++) {
            appiArray.add(new GoodsInfo2(appiImageArray[i], appiTitleArray[i], null));
        }
        return appiArray;
    }
