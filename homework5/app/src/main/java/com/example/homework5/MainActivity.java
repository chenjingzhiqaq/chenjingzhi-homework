...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String mPassword = "18990123"; // 默认密码
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","陈敬之-18990123"};
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) { // 点击了“忘记密码”按钮
            ...
            if (rb_password.isChecked()) { // 选择了密码方式校验，此时要跳到找回密码页面
                Intent intent = new Intent(this, com.example.homework5.LoginForgetActivity.class);
                // 携带手机号码跳转到找回密码页面
